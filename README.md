...
```
bash <(curl -Ls https://raw.githubusercontent.com/Aryan-Ebadi/xpanel/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/Aryan-Ebadi/xpanel/master/install.sh) v2.4.1
```
